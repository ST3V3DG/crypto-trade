		...
		<section className="max-w-5xl mx-auto px-6 py-24">
			...
			<div className="max-w-2xl mb-20">
				...
				<p className="text-lg md:text-xl text-gray-400 text-left">
					Experience professional-grade trading tools and features designed for both novice and experienced
					crypto traders.
				</p>
			</div>
			...
			<Tabs defaultValue={features[0].title} className="w-full">
				<div className="grid grid-cols-1 md:grid-cols-12 gap-12">
					...
					<div className="md:col-span-7">
						{features.map((feature) => (
							<TabsContent key={feature.title} value={feature.title} className="mt-0 h-full">
